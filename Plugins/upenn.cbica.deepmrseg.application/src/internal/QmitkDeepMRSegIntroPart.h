...
#ifndef QMITKDeepMRSegINTROPART_H_
#define QMITKDeepMRSegINTROPART_H_

#include <QtCore/qconfig.h>

#include <berryQtIntroPart.h>
#include <ui_QmitkDeepMRSegWelcomeScreenViewControls.h>


/**
 * \ingroup org_mitk_gui_qt_welcomescreen_internal
 * \brief QmitkDeepMRSegIntroPart
...
class QmitkDeepMRSegIntroPart : public berry::QtIntroPart
{
...
public:
  ...
  QmitkDeepMRSegIntroPart();
 ~QmitkDeepMRSegIntroPart() override;
...
protected:
  ...
  Ui::QmitkDeepMRSegWelcomeScreenViewControls* m_Controls;

  class Impl;
  Impl* m_Impl;
};

#endif /* QMITKDeepMRSegINTROPART_H_ */
